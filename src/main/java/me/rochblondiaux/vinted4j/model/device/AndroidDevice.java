...
@Getter
public class AndroidDevice extends MobileDevice implements Serializable {
    ...
    public AndroidDevice(String formatted) {
        ...
        String[] resolution = displayResolution.split("x");
        this.width = resolution[0];
        this.height = resolution[1];
    }

    public static String toUserAgent(String formatted) {
        return String.format("vinted-android / fr.vinted v%s (%s; %s)",
                VintedConstants.APP_VERSION,
                formatted,
                VintedConstants.LOCALE);
    }

    public static final AndroidDevice[] GOOD_DEVICES = {
            /*
             * SSamsung Galaxy S22 SM-S906N.
             ...
             */
            new AndroidDevice("23/6.0.1; 640dpi; 1440x2392; LGE/lge; RS988; h1; h1"),
             ...
             */
            new AndroidDevice("24/7.0; 640dpi; 1440x2560; HUAWEI; LON-L29; HWLON; hi3660"),
             ...
             */
            new AndroidDevice("23/6.0.1; 640dpi; 1440x2560; ZTE; ZTE A2017U; ailsa_ii; qcom"),
